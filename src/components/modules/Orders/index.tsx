...
export const Orders: React.FC<OrdersProps> = ({ active, perPage }) => {
      ...
      {isLoading ? (
        ...
        <Table className="w-full">
          <TableHeader>
            ...
            <TableRow>
              <TableHead className="py-4">carrier</TableHead>
              <TableHead className="py-4">
                Subscription <br />
                Length
              </TableHead>
              <TableHead className="py-4">Order Date</TableHead>
              <TableHead className="py-4">
                order <br />
                number
              </TableHead>
              ...
              <TableHead className="py-4">discount</TableHead>
            ...
            {orders.orders.map((item, index) => (
              <TableRow key={index}>
                ...
                <TableCell
                  ...
                  className="text-[#9B9A9D] text-base"
                >
                  {item.discount_code !== null ? item.discount_code : "-"}
                </TableCell>
                <TableCell
                  data-label="discount"
                  className="text-[#9B9A9D] text-base"
