      ...
      <div ref={ref}>
        <DayPicker
          ...
          classNames={{
            ...
            day_selected:
              "bg-custom-gradient-2 overflow-hidden text-primary-foreground hover:bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground",
