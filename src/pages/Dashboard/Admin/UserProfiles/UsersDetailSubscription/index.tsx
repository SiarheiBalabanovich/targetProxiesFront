...
const AdminUsersDetailSubscription: React.FC = () => {
    ...
    <div className="flex min-h-lvh bg-[#0E0E16]">
      ...
      <div className="w-full pt-[27px] pb-[110px] px-5 flex flex-col gap-[40px] lg:px-10 xl:px-12 2xl:px-14 overflow-x-hidden">
        ...
        <div className="flex flex-col gap-5 w-full max-w-[1416px]">
          ...
          <div className="p-10 bg-custom-gradient-3 rounded-[7px] flex-col justify-start items-start flex w-full max-mobile-2:p-6">
            <div className="w-full grid grid-cols-3 gap-x-6 gap-y-8 max-mobile-1:grid-cols-2 max-mobile-1:gap-y-6  max-mobile-2:grid-cols-1">
              ...
              <Label className="flex w-full gap-4 flex-col">
                ...
                <div className="relative w-full">
                  <Select defaultValue="Mississippi">
                    <SelectTrigger className="w-full text-base">
                    ...
                    <SelectContent>
                      <SelectGroup>
                        ...
                        <SelectItem value="Mississippi 1">
                          Mississippi 1
                        </SelectItem>
                      </SelectGroup>
                    </SelectContent>
              ...
              <Label className="w-full gap-4 flex-col hidden h-0 opacity-0 pointer-events-none">
                <div>
                  <span className="text-[#6F7279] text-sm uppercase leading-tight">
                    rotation
                  </span>
...
export default AdminUsersDetailSubscription;
